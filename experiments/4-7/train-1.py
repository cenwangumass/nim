...
if __name__ == "__main__":
    train_dataset = load("experiments/4-7/train.npy")
    train_dataloader = DataLoader(train_dataset, batch_size=1000)

    net = Net(x_dim=1, h_dim=64, lr=0.002, step_size=1000, gamma=0.98)
    trainer = pl.Trainer(
        gpus=1,
        max_epochs=40000,
        precision=32,
    ...
    trainer.save_checkpoint("experiments/4-7/model-1.ckpt")
